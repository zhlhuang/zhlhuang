...
class alipay extends sqlTool{
	  ...
	  $sql="INSERT INTO `alipay`(`out_trade_no`, `trade_no`, `trade_status`, `buyer_email`, `gmt_payment`, `price`, `seller_email`) VALUES ('".$out_trade_no."','".$trade_no."','".$trade_status."','".$buyer_email."','".$gmt_payment."','".$price."','".$seller_email."') ";
