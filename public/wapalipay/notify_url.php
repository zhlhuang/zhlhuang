...
if($verify_result) {//验证成功
	...
	file_put_contents("notify_data.txt",$notify_data);//将得到的信息存入到文件中
...
function  getall(){
	...
	if( ! empty($doc->getElementsByTagName( "notify" )->item(0)->nodeValue) ) {
		...
		//交易金额
		$price = $doc->getElementsByTagName( "total_fee" )->item(0)->nodeValue;
		//卖家id
		...
		"buyer_email"=>$buyer_email,"gmt_paymen"=>$gmt_paymen,"price"=>$price,
